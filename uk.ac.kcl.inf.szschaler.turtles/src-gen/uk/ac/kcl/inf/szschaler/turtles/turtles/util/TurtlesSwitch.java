...
public class TurtlesSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        PenMoveStatement penMoveStatement = (PenMoveStatement)theEObject;
        T result = casePenMoveStatement(penMoveStatement);
        if (result == null) result = caseStatement(penMoveStatement);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case TurtlesPackage.EXPRESSION:
      {
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Pen Move Statement</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Pen Move Statement</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T casePenMoveStatement(PenMoveStatement object)
  {
    return null;
  }
